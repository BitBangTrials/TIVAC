...
#define PWM_FREQUENCY 50 //PWM frequency of 50 Hz, which is a period of 20ms.
...
int main(void)
{
    ...
    ui8Adjust = 75;
    //Create our variables used by our PWM to control the servo.  75 is our center position to create an approximate
    ...
    //With a period of 20ms, each step will be 20us.
    ...
    while(1)
    {
        ...
        ROM_SysCtlDelay(200000); //Delay between actions, causes servo speed to be slowed by microcontroller delay.
    }
